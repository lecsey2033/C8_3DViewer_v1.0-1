...
void MainWindow::on_object_activated(int index)
{
    ...
    dataTextEdit(strdata, this->ui->widget->objdata.amount_of_vertexes, this->ui->widget->objdata.amount_of_facets);
}
...
void MainWindow::on_image_clicked()
{
    ...
    strdata.chop(4);
    QString file = QFileDialog::getSaveFileName(this, "Save as...", strdata, "BMP (*.bmp);; JPEG (*.jpeg)");
    image.save(file);
}
...
void MainWindow::done()
{
    ...
    QVector<QRgb> ctable;
    ctable << qRgb((int)(this->ui->widget->Vred * 255), (int)(this->ui->widget->Vgreen * 255), (int)(this->ui->widget->Vblue * 255))
           << qRgb((int)(this->ui->widget->Lred * 255), (int)(this->ui->widget->Lgreen * 255), (int)(this->ui->widget->Lblue * 255))
           << qRgb((int)(this->ui->widget->BGred * 255), (int)(this->ui->widget->BGgreen * 255), (int)(this->ui->widget->BGblue * 255));
...
void MainWindow::saveSettings()
{
    ...
    settings->setValue("type_of_vertexes", this->ui->type_of_vertexes->currentIndex());
...
void MainWindow::loadSettings()
{
    ...
    this->ui->type_of_edges->setCurrentIndex(settings->value("type_of_edges").toInt());
    on_type_of_edges_activated(settings->value("type_of_edges").toInt());
    this->ui->doubleSpinBox_3->setValue(settings->value("doubleSpinBox_3").toDouble());
    ...
    this->ui->type_of_vertexes->setCurrentIndex(settings->value("type_of_vertexes").toInt());
    on_type_of_vertexes_activated(settings->value("type_of_vertexes").toInt());
    this->ui->size_of_vertexes->setValue(settings->value("size_of_vertexes").toDouble());
